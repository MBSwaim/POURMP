...
- **Simplify client records** to a minimal event-scoped contact card (name + day-of phone/email). Drop `referral_source`, `company`, and the freeform client `notes` field.
